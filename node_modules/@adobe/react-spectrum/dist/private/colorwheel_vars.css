.ogcnoG_spectrum-ColorControl-hiddenField {
  opacity: .0001;
  z-index: 0;
  pointer-events: none;
  width: 100%;
...
.ogcnoG_spectrum-ColorWheel.ogcnoG_spectrum-ColorWheel {
...
.ogcnoG_spectrum-ColorWheel.ogcnoG_spectrum-ColorWheel .ogcnoG_spectrum-ColorWheel-handle {
  margin: 0;
}

.ogcnoG_spectrum-ColorWheel.ogcnoG_spectrum-ColorWheel.ogcnoG_is-focused {
  z-index: 2;
}

.ogcnoG_spectrum-ColorWheel.ogcnoG_spectrum-ColorWheel.ogcnoG_is-disabled {
  pointer-events: none;
}

.ogcnoG_spectrum-ColorWheel.ogcnoG_spectrum-ColorWheel.ogcnoG_is-dragged {
  z-index: 2;
}

.ogcnoG_spectrum-ColorWheel-gradient {
  z-index: 0;
  width: calc(var(--spectrum-global-dimension-size-125) * 16);
  height: calc(var(--spectrum-global-dimension-size-125) * 16);
  position: relative;
...
.ogcnoG_spectrum-ColorWheel-gradient:before, .ogcnoG_spectrum-ColorWheel-gradient:after {
  content: "";
...
.ogcnoG_spectrum-ColorWheel-gradient:before {
  inset: 0;
}

.ogcnoG_spectrum-ColorWheel-gradient:after {
...
.ogcnoG_spectrum-ColorWheel.ogcnoG_is-disabled .ogcnoG_spectrum-ColorWheel-gradient {
  background: var(--spectrum-colorwheel-fill-color-disabled, var(--spectrum-global-color-gray-300)) !important;
}

.ogcnoG_spectrum-ColorWheel.ogcnoG_is-disabled .ogcnoG_spectrum-ColorWheel-gradient:before, .ogcnoG_spectrum-ColorWheel.ogcnoG_is-disabled .ogcnoG_spectrum-ColorWheel-gradient:after {
  border-color: var(--spectrum-colorwheel-border-color-disabled, var(--spectrum-global-color-gray-300));
}

.ogcnoG_spectrum-ColorWheel.ogcnoG_is-disabled .ogcnoG_spectrum-ColorWheel-segment {
  display: none;
}
...
/*# sourceMappingURL=colorwheel_vars.css.map */
