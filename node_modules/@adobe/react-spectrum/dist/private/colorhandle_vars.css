.wssHda_spectrum-ColorHandle {
  ...
  background-position: calc(-1 * var(--spectrum-global-dimension-static-size-25, 2px)) calc(-1 * var(--spectrum-global-dimension-static-size-25, 2px)),
    calc(-1 * var(--spectrum-global-dimension-static-size-25, 2px))
      calc(var(--spectrum-global-dimension-static-size-100, 8px) +
          calc(-1 * var(--spectrum-global-dimension-static-size-25, 2px))),
    calc(var(--spectrum-global-dimension-static-size-100, 8px) +
          calc(-1 * var(--spectrum-global-dimension-static-size-25, 2px)))
    ...
    calc(-1 * var(--spectrum-global-dimension-static-size-100, 8px) +
          calc(-1 * var(--spectrum-global-dimension-static-size-25, 2px)))
      calc(-1 * var(--spectrum-global-dimension-static-size-25, 2px));
  transition: width var(--spectrum-global-animation-duration-100, .13s)
      ease-in-out,
    height var(--spectrum-global-animation-duration-100, .13s)
      ease-in-out,
    border-width var(--spectrum-global-animation-duration-100, .13s)
      ease-in-out,
    margin-left var(--spectrum-global-animation-duration-100, .13s)
      ease-in-out,
    margin-top var(--spectrum-global-animation-duration-100, .13s)
      ease-in-out;
  border-style: solid;
  display: block;
  position: absolute;
...
.wssHda_spectrum-ColorHandle, .wssHda_spectrum-ColorHandle:after {
  border-radius: 100%;
}

.wssHda_spectrum-ColorHandle:after {
  content: "";
...
.wssHda_spectrum-ColorHandle.wssHda_is-disabled {
  pointer-events: none;
}

.wssHda_spectrum-ColorControl-handle--focused {
...
.wssHda_spectrum-ColorHandle-color {
  border-radius: 100%;
  width: 100%;
  height: 100%;
}
...
.wssHda_spectrum-ColorHandle {
  ...
  box-shadow: 0 0 0 var(--spectrum-colorhandle-outer-border-size, var(--spectrum-global-dimension-static-size-10))
    #0000006b;
...
.wssHda_spectrum-ColorHandle.wssHda_is-disabled .wssHda_spectrum-ColorHandle-color {
  display: none;
}

.wssHda_spectrum-ColorHandle-color {
  box-shadow: inset 0 0 0 var(--spectrum-colorhandle-outer-border-size, var(--spectrum-global-dimension-static-size-10))
    #0000006b;
}
...
/*# sourceMappingURL=colorhandle_vars.css.map */
