.FOJCkq_i18nFontFamily {
  font-synthesis: weight;
  font-family: adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(ar) {
  font-family: myriad-arabic, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(he) {
  font-family: myriad-hebrew, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(zh) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Heiti TC Light, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(zh-Hans) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(zh-Hant) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Microsoft JhengHei UI, Microsoft JhengHei, Heiti TC Light, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(zh-SG), .FOJCkq_i18nFontFamily:lang(zh-CN) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(ko) {
  font-family: adobe-clean-han-korean, source-han-korean, Malgun Gothic, Apple Gothic, sans-serif;
}

.FOJCkq_i18nFontFamily:lang(ja) {
...
.FOJCkq_spectrum-FocusRing-ring {
...
.FOJCkq_spectrum-FocusRing-ring:after {
...
.FOJCkq_spectrum-FocusRing.FOJCkq_focus-ring:after {
  margin: calc(var(--spectrum-focus-ring-gap) * -1 - var(--spectrum-focus-ring-border-size));
  box-shadow: 0 0 0 var(--spectrum-focus-ring-size) var(--spectrum-focus-ring-color);
}

.FOJCkq_spectrum-FocusRing--quiet:after {
  border-radius: 0;
}

.FOJCkq_spectrum-FocusRing--quiet.FOJCkq_focus-ring:after {
...
@media (forced-colors: active) {
  .FOJCkq_spectrum-FocusRing, .FOJCkq_spectrum-FocusRing-ring, .FOJCkq_spectrum-FocusRing--quiet {
    --spectrum-high-contrast-focus-ring-color: Highlight;
  }

  :is(.FOJCkq_spectrum-FocusRing, .FOJCkq_spectrum-FocusRing-ring, .FOJCkq_spectrum-FocusRing--quiet):after {
    forced-color-adjust: none;
  }
}

.FOJCkq_spectrum-StatusLight {
...
.FOJCkq_spectrum-StatusLight:before {
  content: "";
  ...
  margin: calc(var(--spectrum-global-dimension-size-65) + 1px) var(--spectrum-statuslight-text-gap, var(--spectrum-global-dimension-size-150))
      calc(var(--spectrum-global-dimension-size-65) - 1px) var(--spectrum-statuslight-text-gap, var(--spectrum-global-dimension-size-150));
  border-radius: 50%;
  flex-grow: 0;
  flex-shrink: 0;
...
.FOJCkq_spectrum-StatusLight--neutral {
  font-style: italic;
}
...
/*# sourceMappingURL=statuslight_vars.css.map */
