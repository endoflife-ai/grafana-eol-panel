.A7dsgq_spectrum-ColorControl-hiddenField {
  opacity: .0001;
  z-index: 0;
  pointer-events: none;
  width: 100%;
...
.A7dsgq_spectrum-ColorSlider .A7dsgq_spectrum-ColorSlider-handle.A7dsgq_spectrum-ColorSlider-handle {
  margin: 0;
}

.A7dsgq_spectrum-ColorSlider:before {
  content: "";
  z-index: -1;
  border-radius: var(--spectrum-colorslider-border-radius, var(--spectrum-alias-border-radius-regular));
...
.A7dsgq_spectrum-ColorSlider.A7dsgq_is-focused {
  z-index: 2;
}

.A7dsgq_spectrum-ColorSlider.A7dsgq_is-disabled {
  pointer-events: none;
}

.A7dsgq_spectrum-ColorSlider--vertical {
  width: var(--spectrum-colorslider-vertical-width, var(--spectrum-global-dimension-size-300));
  flex: 1;
  display: inline-block;
}

.A7dsgq_spectrum-ColorSlider--vertical .A7dsgq_spectrum-ColorSlider-handle {
  top: 0;
  left: 50%;
}

.A7dsgq_spectrum-ColorSlider-handle {
  top: 50%;
  left: 0;
}

.A7dsgq_spectrum-ColorSlider-handle:after {
  width: var(--spectrum-global-dimension-size-300);
  height: var(--spectrum-global-dimension-size-300);
  border-radius: 0%;
}

.A7dsgq_spectrum-ColorSlider-labelContainer {
  grid-template-columns: auto 1fr auto;
  grid-template-areas: "A7dsgq_label A7dsgq_contextualHelp A7dsgq_value";
  justify-items: start;
  display: grid;
}

.A7dsgq_spectrum-ColorSlider-contextualHelp.A7dsgq_spectrum-ColorSlider-contextualHelp {
  margin-inline-start: var(--spectrum-global-dimension-size-50);
  margin-top: var(--spectrum-global-dimension-size-25);
  grid-area: A7dsgq_contextualHelp;
}

.A7dsgq_spectrum-ColorSlider-valueLabel {
  grid-area: A7dsgq_value;
  margin-inline-start: var(--spectrum-global-dimension-size-50);
}

.A7dsgq_spectrum-ColorSlider {
  background-color: var(--spectrum-global-color-static-white, #fff);
  box-shadow: inset 0 0 0 var(--spectrum-colorslider-border-size, var(--spectrum-alias-border-size-thin))
...
.A7dsgq_spectrum-ColorSlider.A7dsgq_is-disabled {
  box-shadow: inset 0 0 0 var(--spectrum-colorslider-border-size, var(--spectrum-alias-border-size-thin))
      var(--spectrum-colorslider-border-color-disabled, var(--spectrum-global-color-gray-300));
...
/*# sourceMappingURL=colorslider_vars.css.map */
