.n5vxYq_i18nFontFamily {
  font-synthesis: weight;
  font-family: adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(ar) {
  font-family: myriad-arabic, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(he) {
  font-family: myriad-hebrew, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(zh) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Heiti TC Light, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(zh-Hans) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(zh-Hant) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Microsoft JhengHei UI, Microsoft JhengHei, Heiti TC Light, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(zh-SG), .n5vxYq_i18nFontFamily:lang(zh-CN) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(ko) {
  font-family: adobe-clean-han-korean, source-han-korean, Malgun Gothic, Apple Gothic, sans-serif;
}

.n5vxYq_i18nFontFamily:lang(ja) {
...
.n5vxYq_spectrum-FocusRing-ring {
...
.n5vxYq_spectrum-FocusRing-ring:after {
...
.n5vxYq_spectrum-FocusRing.n5vxYq_focus-ring:after {
  margin: calc(var(--spectrum-focus-ring-gap) * -1 - var(--spectrum-focus-ring-border-size));
  box-shadow: 0 0 0 var(--spectrum-focus-ring-size) var(--spectrum-focus-ring-color);
}

.n5vxYq_spectrum-FocusRing--quiet:after {
  border-radius: 0;
}

.n5vxYq_spectrum-FocusRing--quiet.n5vxYq_focus-ring:after {
...
@media (forced-colors: active) {
  .n5vxYq_spectrum-FocusRing, .n5vxYq_spectrum-FocusRing-ring, .n5vxYq_spectrum-FocusRing--quiet {
    --spectrum-high-contrast-focus-ring-color: Highlight;
  }

  :is(.n5vxYq_spectrum-FocusRing, .n5vxYq_spectrum-FocusRing-ring, .n5vxYq_spectrum-FocusRing--quiet):after {
    forced-color-adjust: none;
  }
}

.n5vxYq_spectrum-Radio {
  --spectrum-radio-radius: calc(var(--spectrum-radio-circle-diameter, var(--spectrum-global-dimension-size-175)) / 2);
  --spectrum-radio-border-width-checked: calc(calc(var(--spectrum-radio-circle-diameter, var(--spectrum-global-dimension-size-175)) / 2) -
      calc(var(--spectrum-radio-circle-dot-size, var(--spectrum-global-dimension-static-size-50)) / 2));
...
.n5vxYq_spectrum-Radio-input {
  ...
  position: absolute;
  inset-block-start: 0;
  inset-inline-start: calc(var(--spectrum-radio-cursor-hit-x, var(--spectrum-global-dimension-size-100)) * -1);
  overflow: visible;
}

.n5vxYq_spectrum-Radio-input:disabled {
  cursor: default;
}

.n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button:before {
  border-width: var(--spectrum-radio-border-width-checked);
}

.n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring + .n5vxYq_spectrum-Radio-button:after {
  margin: calc(var(--spectrum-alias-focus-ring-gap, var(--spectrum-global-dimension-static-size-25)) * -1);
}

.n5vxYq_spectrum-Radio-label {
  text-align: start;
...
.n5vxYq_spectrum-Radio-button:before {
  z-index: 0;
  content: "";
  box-sizing: border-box;
...
.n5vxYq_spectrum-Radio-button:after {
  content: "";
...
.n5vxYq_spectrum-Radio--labelBelow {
...
.n5vxYq_spectrum-Radio--labelBelow .n5vxYq_spectrum-Radio-button {
  flex-shrink: 0;
  margin: 0;
}

.n5vxYq_spectrum-Radio--labelBelow .n5vxYq_spectrum-Radio-label {
  margin: var(--spectrum-radio-labelbelow-label-margin);
}

.n5vxYq_spectrum-Radio .n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button:before {
...
.n5vxYq_spectrum-Radio.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-hover, var(--spectrum-global-color-gray-700));
  box-shadow: none;
}

.n5vxYq_spectrum-Radio.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-selected-hover, var(--spectrum-global-color-blue-600));
}

.n5vxYq_spectrum-Radio.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-label {
  color: var(--spectrum-radio-emphasized-text-color-hover, var(--spectrum-alias-text-color-hover));
}

.n5vxYq_spectrum-Radio:active .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-down, var(--spectrum-global-color-gray-800));
}

.n5vxYq_spectrum-Radio:active .n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-selected-down, var(--spectrum-global-color-blue-700));
}

.n5vxYq_spectrum-Radio:active .n5vxYq_spectrum-Radio-label {
  color: var(--spectrum-radio-emphasized-text-color-down, var(--spectrum-alias-text-color-down));
}

:is(.n5vxYq_spectrum-Radio .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring, .n5vxYq_spectrum-Radio.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring):checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-selected-hover, var(--spectrum-global-color-blue-600));
}

.n5vxYq_spectrum-Radio--quiet .n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-quiet-circle-border-color-selected, var(--spectrum-global-color-gray-700));
}

.n5vxYq_spectrum-Radio--quiet.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-quiet-circle-border-color-selected-hover, var(--spectrum-global-color-gray-800));
}

.n5vxYq_spectrum-Radio--quiet:active .n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-quiet-circle-border-color-selected-down, var(--spectrum-global-color-gray-900));
}

:is(.n5vxYq_spectrum-Radio--quiet .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring, .n5vxYq_spectrum-Radio--quiet.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring):checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-quiet-circle-border-color-selected-key-focus, var(--spectrum-global-color-gray-800));
}

:is(:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid .n5vxYq_spectrum-Radio-button, :is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid .n5vxYq_spectrum-Radio-input:checked + .n5vxYq_spectrum-Radio-button):before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-error, var(--spectrum-global-color-red-500));
}

:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid .n5vxYq_spectrum-Radio-label {
  color: var(--spectrum-radio-emphasized-circle-border-color-error, var(--spectrum-global-color-red-500));
}

:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-error-hover, var(--spectrum-global-color-red-600));
}

:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-label {
  color: var(--spectrum-radio-emphasized-circle-border-color-error-hover, var(--spectrum-global-color-red-600));
}

:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid:active .n5vxYq_spectrum-Radio-input + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-error-down, var(--spectrum-global-color-red-700));
}

:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid:active .n5vxYq_spectrum-Radio-label {
  color: var(--spectrum-radio-emphasized-circle-border-color-error-down, var(--spectrum-global-color-red-700));
}

:is(:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring, :is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring):not(:checked) + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-circle-border-color-error-key-focus, var(--spectrum-global-color-red-600));
}

:is(:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring, :is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-invalid.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring):checked + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-circle-border-color-error-selected-key-focus, var(--spectrum-global-color-red-600));
}

.n5vxYq_spectrum-Radio-input:disabled + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-emphasized-circle-border-color-disabled, var(--spectrum-global-color-gray-400)) !important;
}

.n5vxYq_spectrum-Radio-input:disabled ~ .n5vxYq_spectrum-Radio-label {
  color: var(--spectrum-radio-emphasized-text-color-disabled, var(--spectrum-alias-text-color-disabled)) !important;
}

:is(:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet) .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring, :is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring):not(:checked) + .n5vxYq_spectrum-Radio-button:before {
  border-color: var(--spectrum-radio-circle-border-color-key-focus, var(--spectrum-global-color-gray-700));
}

:is(:is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet) .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring, :is(.n5vxYq_spectrum-Radio, .n5vxYq_spectrum-Radio--quiet).n5vxYq_is-hovered .n5vxYq_spectrum-Radio-input.n5vxYq_focus-ring) + .n5vxYq_spectrum-Radio-button:after {
  box-shadow: 0 0 0 var(--spectrum-radio-focus-ring-size-key-focus, var(--spectrum-alias-focus-ring-size))
          var(--spectrum-radio-focus-ring-color-key-focus, var(--spectrum-alias-focus-ring-color));
}
...
@media (forced-colors: active) {
  ...
  .n5vxYq_spectrum-Radio.n5vxYq_is-invalid.n5vxYq_is-hovered .n5vxYq_spectrum-Radio-label, .n5vxYq_spectrum-Radio.n5vxYq_is-invalid:active .n5vxYq_spectrum-Radio-label {
    color: var(--spectrum-radio-emphasized-circle-border-color-error, var(--spectrum-global-color-red-500));
  }
}
/*# sourceMappingURL=radio_vars.css.map */
