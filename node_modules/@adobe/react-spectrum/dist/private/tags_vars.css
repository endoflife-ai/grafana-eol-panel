.MUkjgG_i18nFontFamily {
  font-synthesis: weight;
  font-family: adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(ar) {
  font-family: myriad-arabic, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(he) {
  font-family: myriad-hebrew, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(zh) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Heiti TC Light, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(zh-Hans) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(zh-Hant) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Microsoft JhengHei UI, Microsoft JhengHei, Heiti TC Light, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(zh-SG), .MUkjgG_i18nFontFamily:lang(zh-CN) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(ko) {
  font-family: adobe-clean-han-korean, source-han-korean, Malgun Gothic, Apple Gothic, sans-serif;
}

.MUkjgG_i18nFontFamily:lang(ja) {
...
.MUkjgG_spectrum-FocusRing-ring {
...
.MUkjgG_spectrum-FocusRing-ring:after {
...
.MUkjgG_spectrum-FocusRing.MUkjgG_focus-ring:after {
  margin: calc(var(--spectrum-focus-ring-gap) * -1 - var(--spectrum-focus-ring-border-size));
  box-shadow: 0 0 0 var(--spectrum-focus-ring-size) var(--spectrum-focus-ring-color);
}

.MUkjgG_spectrum-FocusRing--quiet:after {
  border-radius: 0;
}

.MUkjgG_spectrum-FocusRing--quiet.MUkjgG_focus-ring:after {
...
@media (forced-colors: active) {
  .MUkjgG_spectrum-FocusRing, .MUkjgG_spectrum-FocusRing-ring, .MUkjgG_spectrum-FocusRing--quiet {
    --spectrum-high-contrast-focus-ring-color: Highlight;
  }

  :is(.MUkjgG_spectrum-FocusRing, .MUkjgG_spectrum-FocusRing-ring, .MUkjgG_spectrum-FocusRing--quiet):after {
    forced-color-adjust: none;
  }
}

.MUkjgG_spectrum-Tags {
  display: inline;
}

.MUkjgG_spectrum-Tags.MUkjgG_focus-ring {
  box-shadow: 0 0 0 2px var(--spectrum-tag-border-color-key-focus, var(--spectrum-alias-border-color-focus));
  outline: none;
  display: block;
}

.MUkjgG_spectrum-Tags-container:not(.MUkjgG_spectrum-Tags-container--empty) {
...
.MUkjgG_spectrum-Tag {
  ...
  cursor: default;
  margin: calc(var(--spectrum-taggroup-tag-gap-y, var(--spectrum-global-dimension-size-100)) / 2)
    calc(var(--spectrum-taggroup-tag-gap-x, var(--spectrum-global-dimension-size-100)) / 2);
  ...
  transition: border-color var(--spectrum-global-animation-duration-100, .13s) ease-in-out,
    ...
    background-color var(--spectrum-global-animation-duration-100, .13s) ease-in-out;
  border-style: solid;
  outline: none;
  align-items: center;
...
.MUkjgG_spectrum-Tag[data-href] {
  cursor: pointer;
}

.MUkjgG_spectrum-Tag.MUkjgG_is-disabled {
  cursor: default;
  pointer-events: none;
}

.MUkjgG_spectrum-Tag .MUkjgG_spectrum-Tag-removeButton {
  ...
  grid-area: MUkjgG_action;
}

.MUkjgG_spectrum-Tag .MUkjgG_spectrum-Tag-cell {
  text-overflow: ellipsis;
  grid-template-columns: auto 1fr auto;
  grid-template-areas: "MUkjgG_decoration MUkjgG_content MUkjgG_action";
  align-items: center;
  display: grid;
  overflow: hidden;
}

.MUkjgG_spectrum-Tag .MUkjgG_spectrum-Tag-icon, .MUkjgG_spectrum-Tag .MUkjgG_spectrum-Tag-avatar {
  grid-area: MUkjgG_decoration;
  margin-inline-end: var(--spectrum-global-dimension-size-100);
}

.MUkjgG_spectrum-Tag .MUkjgG_spectrum-Tag-content {
  ...
  outline: none;
  flex: auto;
  grid-area: MUkjgG_content;
  margin-inline-end: var(--spectrum-tag-padding-x, var(--spectrum-global-dimension-size-125));
  overflow: hidden;
}

.MUkjgG_spectrum-Tag.MUkjgG_spectrum-Tag--removable .MUkjgG_spectrum-Tag-content {
  margin-inline-end: 0;
}

.MUkjgG_spectrum-Tags-actions {
  display: inline;
}

.MUkjgG_spectrum-Tags-actions .MUkjgG_spectrum-Tags-actionButton {
...
.MUkjgG_spectrum-Tags-actions .MUkjgG_spectrum-Tags-actionButton.MUkjgG_spectrum-Tags-actionButton > span {
...
.MUkjgG_spectrum-Tags-fieldWrapper.MUkjgG_spectrum-Tags-fieldWrapper {
  width: unset;
}

.MUkjgG_spectrum-Tags-fieldWrapper.MUkjgG_spectrum-Tags-fieldWrapper:not(.MUkjgG_spectrum-Tags-fieldWrapper--positionSide) {
  display: grid;
}

.MUkjgG_spectrum-Tags-empty-state {
...
.MUkjgG_spectrum-Tag.MUkjgG_is-hovered {
...
.MUkjgG_spectrum-Tag.MUkjgG_focus-ring {
...
.MUkjgG_spectrum-Tag.MUkjgG_focus-ring:after {
  box-shadow: 0 0 0 var(--spectrum-focus-ring-border-size)
        var(--spectrum-tag-border-color-key-focus, var(--spectrum-alias-border-color-focus));
}
...
.MUkjgG_spectrum-Tag.MUkjgG_is-disabled .MUkjgG_spectrum-Tag-avatar {
  opacity: var(--spectrum-avatar-small-opacity-disabled, .3);
}

.MUkjgG_spectrum-Tag.MUkjgG_spectrum-Tag--removable.MUkjgG_is-hovered {
  color: var(--spectrum-tag-removable-text-color-hover, var(--spectrum-global-color-gray-900));
}

.MUkjgG_spectrum-Tag.MUkjgG_spectrum-Tag--removable:active {
  color: var(--spectrum-tag-removable-text-color-down, var(--spectrum-global-color-gray-700));
}

.MUkjgG_spectrum-Tag.MUkjgG_spectrum-Tag--removable.MUkjgG_is-focused {
  color: var(--spectrum-tag-removable-text-color-key-focus, var(--spectrum-global-color-gray-700));
}

.MUkjgG_spectrum-Tag.MUkjgG_spectrum-Tag--removable .MUkjgG_spectrum-Tag-removeButton.MUkjgG_is-focused {
...
.MUkjgG_spectrum-Tag.MUkjgG_spectrum-Tag--removable .MUkjgG_spectrum-Tag-removeButton.MUkjgG_is-hovered {
...
/*# sourceMappingURL=tags_vars.css.map */
