.n6ko7q_i18nFontFamily {
  font-synthesis: weight;
  font-family: adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(ar) {
  font-family: myriad-arabic, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(he) {
  font-family: myriad-hebrew, adobe-clean, Source Sans Pro, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Trebuchet MS, Lucida Grande, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(zh) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Heiti TC Light, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(zh-Hans) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(zh-Hant) {
  font-family: adobe-clean-han-traditional, source-han-traditional, MingLiu, Microsoft JhengHei UI, Microsoft JhengHei, Heiti TC Light, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(zh-SG), .n6ko7q_i18nFontFamily:lang(zh-CN) {
  font-family: adobe-clean-han-simplified-c, source-han-simplified-c, SimSun, Heiti SC Light, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(ko) {
  font-family: adobe-clean-han-korean, source-han-korean, Malgun Gothic, Apple Gothic, sans-serif;
}

.n6ko7q_i18nFontFamily:lang(ja) {
...
.n6ko7q_spectrum-FocusRing-ring {
...
.n6ko7q_spectrum-FocusRing-ring:after {
...
.n6ko7q_spectrum-FocusRing.n6ko7q_focus-ring:after {
  margin: calc(var(--spectrum-focus-ring-gap) * -1 - var(--spectrum-focus-ring-border-size));
  box-shadow: 0 0 0 var(--spectrum-focus-ring-size) var(--spectrum-focus-ring-color);
}

.n6ko7q_spectrum-FocusRing--quiet:after {
  border-radius: 0;
}

.n6ko7q_spectrum-FocusRing--quiet.n6ko7q_focus-ring:after {
...
@media (forced-colors: active) {
  .n6ko7q_spectrum-FocusRing, .n6ko7q_spectrum-FocusRing-ring, .n6ko7q_spectrum-FocusRing--quiet {
    --spectrum-high-contrast-focus-ring-color: Highlight;
  }

  :is(.n6ko7q_spectrum-FocusRing, .n6ko7q_spectrum-FocusRing-ring, .n6ko7q_spectrum-FocusRing--quiet):after {
    forced-color-adjust: none;
  }
}

.n6ko7q_spectrum-InLineAlert {
...
.n6ko7q_spectrum-InLineAlert .n6ko7q_spectrum-InLineAlert-grid {
  column-gap: var(--spectrum-global-dimension-static-size-300, 24px);
  grid-template: "n6ko7q_heading n6ko7q_icon"
                 "n6ko7q_content n6ko7q_content"
                 ". ."
                 / 1fr auto;
  width: 100%;
  display: grid;
...
.n6ko7q_spectrum-InLineAlert.n6ko7q_spectrum-InLineAlert--neutral .n6ko7q_spectrum-InLineAlert-grid {
  grid-template-areas: "n6ko7q_heading"
                       "n6ko7q_content";
  column-gap: 0;
}

.n6ko7q_spectrum-InLineAlert-icon {
  inline-size: var(--spectrum-global-dimension-size-225);
  block-size: var(--spectrum-global-dimension-size-225);
  grid-area: n6ko7q_icon;
}

.n6ko7q_spectrum-InLineAlert-heading {
  ...
  grid-area: n6ko7q_heading;
  margin-block: 0;
  display: block;
}

.n6ko7q_spectrum-InLineAlert-content {
